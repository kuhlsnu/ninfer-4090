...
// project's only entry point to nvtx3, and translation units whose first include is their own
// header reach nvtx3 before any standard header. Pulling <cstdlib> in here satisfies that
// dependency once, for every consumer.
#include <cstdlib>
